...
public class MedicoController {
    ...
    @GetMapping
    public ResponseEntity<Page<DadosListagemMedico>> listaCadastroMedicos(@PageableDefault(size = 10, sort = {"nome"}) Pageable paginacao){
    ...
    @PutMapping
    @Transactional
    public ResponseEntity atualizarCadastro(@RequestBody @Valid DadosAtualizados dados){
